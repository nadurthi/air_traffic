...
addpath(genpath('sigma_quad_points'))
...
legend('PF-mu','PF-mo','ckf','ukf','cut4','cut6','cut8','GH','Location','NorthWest')
xlabel('t (s)')
ylabel('RMSE_{pos} (m)')
% plot_prop_paper
...
methods = {'PF-mu','PF-mo','ckf','ukf','cut4','cut6','cut8'};
pp=1;
a1=zeros(3,8);
a2=zeros(3,8);
errpos_avg=[sqrt(sum(sqrt(sum(est_fin_mupf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_mopf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ckf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ukf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut4(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut6(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut8(:,pp).^2/model.fn,2)).^2)/time.nSteps)] ; %,sqrt(sum(sqrt(sum(est_fin_gh(:,pp).^2/model.fn,2)).^2)/time.nSteps)
errpos_max=[max(max(est_fin_mupf(:,pp))),max(max(est_fin_mopf(:,pp))),max(max(est_fin_ckf(:,pp))),max(max(est_fin_ukf(:,pp))),max(max(est_fin_cut4(:,pp))),max(max(est_fin_cut6(:,pp))),max(max(est_fin_cut8(:,pp)))]; %,max(max(est_fin_gh(:,pp)))

pp=2;
errvel_avg=[sqrt(sum(sqrt(sum(est_fin_mupf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_mopf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ckf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ukf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut4(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut6(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut8(:,pp).^2/model.fn,2)).^2)/time.nSteps)] ; %,sqrt(sum(sqrt(sum(est_fin_gh(:,pp).^2/model.fn,2)).^2)/time.nSteps)
errvel_max=[max(max(est_fin_mupf(:,pp))),max(max(est_fin_mopf(:,pp))),max(max(est_fin_ckf(:,pp))),max(max(est_fin_ukf(:,pp))),max(max(est_fin_cut4(:,pp))),max(max(est_fin_cut6(:,pp))),max(max(est_fin_cut8(:,pp)))]; %,max(max(est_fin_gh(:,pp)))

pp=3;
erromg_avg=[sqrt(sum(sqrt(sum(est_fin_mupf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_mopf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ckf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_ukf(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut4(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut6(:,pp).^2/model.fn,2)).^2)/time.nSteps),sqrt(sum(sqrt(sum(est_fin_cut8(:,pp).^2/model.fn,2)).^2)/time.nSteps)] ; %,sqrt(sum(sqrt(sum(est_fin_gh(:,pp).^2/model.fn,2)).^2)/time.nSteps)
erromg_max=[max(max(est_fin_mupf(:,pp))),max(max(est_fin_mopf(:,pp))),max(max(est_fin_ckf(:,pp))),max(max(est_fin_ukf(:,pp))),max(max(est_fin_cut4(:,pp))),max(max(est_fin_cut6(:,pp))),max(max(est_fin_cut8(:,pp)))]; %,max(max(est_fin_gh(:,pp)))


disp('Position error')
vertcat(methods,num2cell(errpos_avg))
...
% s(find(s==' '))='_';
% s(find(s==':'))='-';
% save(strcat(s,'_airtraffic_eg'),'time','model','pf','filter','xNNN_mc','YNNN_mc','xNNN_mopf','xNNN_mupf','xNNN_ukf','xNNN_ckf','xNNN_cut4','xNNN_cut6','xNNN_cut8','xNNN_gh','xNNN_ekf','PF_complete_data','PNNN_ukf','PNNN_ckf','PNNN_cut4','PNNN_cut6','PNNN_cut8','PNNN_gh','PNNN_ekf','PNNN_pf','a1','a2','-v7.3')
% % end